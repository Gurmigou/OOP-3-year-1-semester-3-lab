...
public class MainActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        View.OnClickListener restartClickListener = v -> {
            model.restartGame();
            updateCells(null);
            updateFutureColors();
        ...
        GridView cellsGrid = findViewById(R.id.cells);
        cellAdapter = new CellAdapter(this, model);
        cellsGrid.setNumColumns(size);
        cellsGrid.setAdapter(cellAdapter);

        GridView.OnItemClickListener cellsOnItemClickListener = (parent, view, position, id) -> {
